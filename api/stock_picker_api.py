...
import sys
import os
# Add the root project directory to path (going up from api/ to project root)
...
from data.realtime_provider import realtime_provider, MarketHours
from data.stock_cache import stock_cache
from data.enhanced_provider import enhanced_provider
...
from data.realtime_provider import realtime_provider
...
async def get_market_status(sid):
    ...
    try:
        from data.realtime_provider import MarketHours
